...
// Wide (uint64) counter, narrow (uint32, matching micros()'s own return type)
// anchor: update()'s elapsed-since-anchor subtraction stays a uint32
// wraparound-correct delta;
