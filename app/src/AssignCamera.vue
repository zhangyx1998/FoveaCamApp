...
const fovea_l = computed(() => cameras.get("24044020") as Camera);
const fovea_r = computed(() => cameras.get("24155467") as Camera);
...
<template>
    ...
    <div class="cameras">
        <StreamView :camera="fovea_l" style="outline: 2px solid cyan;" />
        <StreamView :camera="fovea_r" style="outline: 2px solid greenyellow;" />
    </div>
</template>
