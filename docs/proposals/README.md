...
| [projection-split-view](./projection-split-view.md) | PROPOSED (in flight) | dedicated projection icon; VSCode-style split panes; cross-window move/duplicate drag; freeze-on-close + grace rebind; `projection_auto_close` |
